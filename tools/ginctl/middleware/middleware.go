...
Enter --name auth --apply demo or -n auth -a demo to generate middleware for the application demo. 
Enter --name auth --global true or -n auth -g true generates global middleware. 
Global middleware and local middleware cannot be specified at the same time. Local middleware is generated by default.
		`,
		RunE: GenMiddleware,
	}
